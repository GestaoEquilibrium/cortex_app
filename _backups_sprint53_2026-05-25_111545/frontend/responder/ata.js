// ============================================================================
// CORTEX_APP — ATA Online (resposta cuidador/responsável)
// ============================================================================
// Página pública SEM autenticação.
// URL: /responder/ata.html?token=<uuid>
//
// Fluxo:
//   1. Tela 1: Termo de consentimento
//   2. Tela 2: 23 itens em lista única com scroll
//   3. Tela 3: Agradecimento ("Resposta enviada. Obrigado.")
//
// Escala ATA — Avaliação de Traços Autísticos
//   23 itens. Escala 0-2:
//     0 — Não apresenta
//     1 — Apresenta alguns traços
//     2 — Apresenta vários traços
//   Pontuação total: soma simples 0-46.
//   Ponto de corte: ≥15 sugere TEA.
//
// Cálculo no banco quando responsável clica "Enviar":
//   1. Soma respostas brutas (todos os 23 itens linkados ao fator TOTAL)
//   2. Classificação binária pelo corte 15 (recalculada no JS do laudo)
