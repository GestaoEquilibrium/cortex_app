// ============================================================================
// CORTEX_APP — BAARS-IV Online (autoavaliação adulto)
// ============================================================================
// Página pública SEM autenticação.
// URL: /responder/baarsiv.html?token=<uuid>
//
// Fluxo (idêntico ao RAADS-R):
//   1. Tela 1: Termo de consentimento
//   2. Tela 2: 27 itens em lista única com scroll (escala 0-3)
//   3. Tela 3: Agradecimento ("Resposta enviada. Obrigado.")
//
// Decisão clínica registrada (Barkley, 2011):
//   BAARS-IV — Autoavaliação de TDAH em adultos (18+). 27 itens em 3
//   subescalas (Desatenção 9, Hiperatividade 9, SCT 9). Escala Likert 0-3.
//   Banco grava índice 0-3. Pontuação clínica especial (sintomas
//   significativos: val ≥ 2) e cutoffs por subescala (DES≥5, HIP≥4) +
//   derivação de subtipo TDAH-C/PI/HI/Abaixo ficam no JS do laudo.
//
// Cálculo no banco quando paciente clica "Enviar":
//   1. Soma respostas brutas como índice 0-3 (publico_finalizar v2)
//   2. JS do laudo conta sintomas (≥2), classifica subescalas, deriva subtipo
