// ============================================================================
// CORTEX_APP — CAT-Q Online (resposta paciente)
// ============================================================================
// Página pública SEM autenticação.
// URL: /responder/catq.html?token=<uuid>
//
// Fluxo (idêntico ao RAADS-R):
//   1. Tela 1: Termo de consentimento
//   2. Tela 2: 25 itens em lista única com scroll
//   3. Tela 3: Agradecimento ("Resposta enviada. Obrigado.")
//
// Decisão clínica registrada (Hull et al., 2019):
//   Escala 1-7 (Discordo Totalmente → Concordo Totalmente). 5 itens reversos.
//   3 subescalas: Compensacao, Mascaramento, Assimilacao + Total.
//   Cutoff TOTAL >100 = Camuflagem Significativa (Faixa Típica caso contrário).
//   Reversos (3,12,19,22,24): fórmula 8-valor, aplicada pelo banco.
//
// Cálculo automático no banco quando paciente clica "Enviar":
//   1. Aplica inversão dos reversos (instrumentos_itens.reverso=true)
//   2. Soma score TOTAL e por FATOR (COMPENSACAO, MASCARAMENTO, ASSIMILACAO)
//   3. Classifica TOTAL em binário (Faixa Típica/Camuflagem Significativa)
//      e cada subescala em 4 faixas (BAIXO/MODERADO/ELEVADO/MUITO ELEVADO)
