// ============================================================================
// CORTEX_APP — EQ-15 Online (resposta paciente)
// ============================================================================
// Página pública SEM autenticação.
// URL: /responder/eq15.html?token=<uuid>
//
// Fluxo (idêntico ao RAADS-R):
//   1. Tela 1: Termo de consentimento
//   2. Tela 2: 15 itens em lista única com scroll
//   3. Tela 3: Agradecimento ("Resposta enviada. Obrigado.")
//
// Decisão clínica registrada (Gouveia et al., 2012):
//   Reversos = 6, 7, 8, 9, 12, 13, 14 (7 itens)
//   Inversão: pontos = 5 - valor (escala 1-4, apenas em reversos)
//   Cutoff TOTAL: ≥30 = clinicamente relevante
//   Faixas: 0-25 Baixa | 26-39 Média | 40-50 Alta | 51-60 Muito Alta
//
// Cálculo automático no banco quando paciente clica "Enviar":
//   1. Aplica inversão dos reversos (instrumentos_itens.reverso=true)
//   2. Soma score TOTAL e por FATOR (EMP_COG, HAB_SOC, REAT_EMO)
//   3. Classifica em 4 faixas
    ...
    function renderPerguntas() {
        ...
        for (const item of state.itens) {
            ...
            for (let v = 1; v <= 4; v++) {
                ...
                const labelTexto = labels[v - 1] || String(v);
                opcoes += `
