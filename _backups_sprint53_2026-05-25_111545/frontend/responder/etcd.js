// ============================================================================
// CORTEX_APP — ETCD Online (Escala DBD de Transtornos Disruptivos)
// ============================================================================
// Página pública SEM autenticação.
// URL: /responder/etcd.html?token=<uuid>
// Respondente: pais, responsáveis ou professores.
//
// Fluxo:
//   1. Tela 1: Termo de consentimento
//   2. Tela 2: 44 itens em lista única com scroll (4 frequências)
//   3. Tela 3: Agradecimento ("Resposta enviada. Obrigado.")
//
// Escala ETCD — DBD Rating Scale (Pelham, Gnagy, Greenslade & Milich, 1992)
//   44 itens distribuídos em 4 subescalas:
//     - TDAH-Desatenção (9)                  · corte ≥ 6 positivos
//     - TDAH-Hiperatividade/Impulsiv. (9)    · corte ≥ 6 positivos
//     - TOD (8)                              · corte ≥ 4 positivos
//     - TC (18)                              · corte ≥ 3 positivos
//
//   Escala armazenada 0-3:
//     0 = Nada · 1 = Pouco · 2 = Muito · 3 = Demais
//
//   Apenas valores ≥ 2 (Muito/Demais) contam como POSITIVOS.
//   TDAH Combinado: Desat ≥ 6 E Hiper ≥ 6
//   Subtipos TC (análise qualitativa cruzando itens TC positivos):
...
//
//   Triagem — NÃO estabelece diagnóstico (DSM-5 exige avaliação multimodal).
//
// Cálculo no banco quando respondente clica "Enviar":
//   1. Salva respostas brutas (44 itens linkados às 4 subescalas)
//   2. Contagem positivos e cortes recalculados no JS do laudo (decisão B)
        ...
        return `
            <div class="tela-consentimento">
                ...
                <ul>
                    ...
                    <li>Para cada comportamento, escolha a <strong>frequência</strong> com que ocorre na criança/adolescente.</li>
                </ul>
    ...
    function renderPerguntas() {
        ...
        let html = `
            <div class="tela-perguntas-instrucoes">
                <p>Para cada comportamento abaixo, escolha a <strong>frequência</strong> com que ele ocorre na criança/adolescente avaliada.</p>
            </div>
