// ============================================================================
// CORTEX_APP — QA 16+ Online (resposta paciente)
// ============================================================================
// Página pública SEM autenticação.
// URL: /responder/qa16.html?token=<uuid>
//
// Fluxo (idêntico ao RAADS-R):
//   1. Tela 1: Termo de consentimento
//   2. Tela 2: 50 itens em lista única com scroll (CT/CP/DP/DT)
//   3. Tela 3: Agradecimento ("Resposta enviada. Obrigado.")
//
// Decisão clínica registrada (Baron-Cohen et al., 2001):
//   QA — Quociente do Espectro do Autismo (AQ-50). 50 itens, escala
//   NÃO-Likert: CT/CP/DP/DT (4 níveis nominais). Banco grava índice 0-3.
//   Pontuação binária via gabarito A/B fica no JS do laudo (NÃO no banco).
//   5 subescalas + score TOTAL (cutoff 32 = clinicamente significativo).
//
// Cálculo no banco quando paciente clica "Enviar":
//   1. Soma respostas brutas como índice 0-3 (publico_finalizar v2)
//   2. JS do laudo aplica regra A/B pra obter score binário e classifica
//   3. Item 30 (sem subescala) linka arbitrariamente a TAT no banco;
//      JS exclui das subescalas mas inclui no total.
