// ============================================================================
// CORTEX_APP — RAADS-R Online (resposta paciente)
// ============================================================================
// Página pública SEM autenticação.
// URL: /responder/raadsr.html?token=<uuid>
//
// Fluxo:
//   1. Tela 1: Termo de consentimento
//   2. Tela 2: 20 itens em lista única com scroll
//   3. Tela 3: Agradecimento ("Resposta enviada. Obrigado.")
//
// Decisão clínica registrada:
//   Reversos = 1, 6, 7, 13, 20 (5 itens — corrige bug do app antigo)
//   Inversão: pontos = 5 - valor (apenas em reversos)
//   Cutoff: ≥46 = Positivo
//
// Cálculo automático no JS quando paciente clica "Enviar":
//   1. Aplica inversão dos reversos
//   2. Soma score total
//   3. Classifica binário
//   4. Envia tudo via publico_finalizar_aplicacao
// ============================================================================
...
(function() {
    ...
    async function carregarAplicacao() {
        try {
            ...
            if (data.instrumento.sigla !== 'RAADS-R') {
