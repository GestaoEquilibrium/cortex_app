        ...
        return `
            <div class="tela-consentimento">
                ...
                <ul>
                    ...
                    <li>Tempo estimado: 15 a 25 minutos.</li>
                    <li>Algumas afirmações se referem à sua relação com seus pais ou parceiro(s) amoroso(s). Se algum deles já tiver falecido, responda com base na sua relação enquanto eram vivos.</li>
                </ul>
    ...
    function renderPerguntas() {
        ...
        let html = `
            <div class="tela-perguntas-instrucoes">
                <p>Leia cada afirmação e escolha a opção que <strong>melhor descreve você ao longo do último ano</strong>. Quando não tiver certeza, baseie sua resposta no que você sente, e não no que acredita racionalmente que é verdade.</p>
            </div>
