    ...
    function renderConsentimento() {
        return `
            <div class="tela-consentimento">
                ...
                <h1>Olá!</h1>
                <p class="subtitulo">Você foi convidado(a) a responder a escala <strong>${escapeHtml(state.norma.versao_label)}</strong> sobre um(a) aluno(a)/criança que você acompanha.</p>

                <h2>Antes de começar</h2>
                <p>Esta escala foi solicitada por um profissional como parte de uma avaliação. Você responde como <strong>informante</strong> (professor[a], pai, mãe ou responsável), com base no que <strong>observou diretamente</strong> no comportamento do(a) aluno(a).</p>

                <h2>Como responder</h2>
                <ul>
                    <li>São <strong>${state.itens.length} itens</strong>. Leia cada um começando com: <em>"O(a) aluno(a) demonstra…"</em></li>
                    <li>Para cada item, marque a <strong>frequência</strong> com que você observou o comportamento (de <em>Nunca</em> a <em>Sempre</em>).</li>
                    ...
                    <li>Tempo estimado: 20 a 30 minutos.</li>
                </ul>
    ...
    function renderPerguntas() {
        ...
        let html = `
            <div class="tela-perguntas-instrucoes">
                <p>Leia cada item começando com <strong>"O(a) aluno(a) demonstra…"</strong> e marque a <strong>frequência</strong> com que você observou o comportamento. Baseie-se no que observou diretamente; avalie cada item de forma independente.</p>
            </div>
