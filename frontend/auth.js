// ============================================================================
// CORTEX_APP — Lógica de autenticação
// ============================================================================
...
async function checkExistingSession() {
    ...
    if (session) {
        // Já está logado, redireciona pro dashboard
...
function setupLoginForm() {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            // Login deu certo
            // Antes de redirecionar, registra na auditoria
...
async function registerLoginAudit(user) {
    try {
        // Busca o profissional vinculado
        ...
        // Falha na auditoria não bloqueia o login
