// ============================================================================
// CORTEX_APP — CARS2-ST (PRESENCIAL) — página dois-modos: INPUT + LAUDO
// ============================================================================
...
(function() {
            ...
            <div class="cars-input">
                <div class="cars-input-head">
                    <div>
                        ...
                        <h1 class="cars-input-tit">CARS2-ST</h1>
    ...
    async function salvar(finalizar) {
        ...
        try {
            ...
            if (finalizar) {
                window.CortexUI.toast('CARS2-ST corrigido', 'success');
    ...
    function renderResultado() {
        ...
        if (!grupo) {
            return `<div class="bai-nivel-expl" style="border-left-color:#94a3b8;">
                ...
                Não foi possível determinar o grupo etário (idade ausente) — a classificação do CARS2-ST é
