// ============================================================================
// CORTEX_APP — AQ-ADOLESCENTE Online (HETEROAPLICAÇÃO — pais respondem)
// ============================================================================
// Página pública SEM autenticação.
// URL: /responder/aqadolescente.html?token=<uuid>
//
// Fluxo (idêntico ao RAADS-R):
//   1. Tela 1: Termo de consentimento
//   2. Tela 2: 50 itens em lista única com scroll (CP/C/D/DT)
//   3. Tela 3: Agradecimento ("Resposta enviada. Obrigado.")
//
// Decisão clínica registrada (Baron-Cohen et al., 2006):
//   AQ-Adolescente Heteroaplicação — pai/mãe/cuidador responde sobre o
//   adolescente (12-15 anos). Itens em 3ª pessoa ("Ele/a..."). 50 itens,
//   escala NÃO-Likert: CP/C/D/DT (4 níveis nominais). Banco grava índice
//   0-3. Pontuação binária via gabarito direto/indireto fica no JS do
//   laudo (NÃO no banco). 5 facetas + score TOTAL (cutoff 26).
//
// Cálculo no banco quando responsável clica "Enviar":
//   1. Soma respostas brutas como índice 0-3 (publico_finalizar v2)
//   2. JS do laudo aplica regra direto/indireto pra obter score binário
