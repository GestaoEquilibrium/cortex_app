// ============================================================================
// CORTEX_APP — ASRS-18 Online (Adult ADHD Self-Report Scale)
// ============================================================================
// Página pública SEM autenticação.
// URL: /responder/asrs18.html?token=<uuid>
// Respondente: o próprio paciente adulto (18+).
//
// Fluxo:
//   1. Tela 1: Termo de consentimento (com banner de respondente)
//   2. Tela 2: 18 itens em lista única com scroll (escala Likert 0-4)
//   3. Tela 3: Agradecimento ("Resposta enviada. Obrigado.")
//
// ASRS-18 — Adler/OMS (Adapt. BR: Mattos et al., 2006)
//   18 itens em 2 partes (dividida pelo JS via número):
//     Parte A — Desatenção (itens 1-9)
//     Parte B — Hiperatividade/Impulsividade (itens 10-18)
//
//   Escala 0-4:
//     0 = Nunca · 1 = Raramente · 2 = Algumas vezes
//     3 = Frequentemente · 4 = Muito frequentemente
//
//   Ponto de corte: Total Geral ≥ 24 (corte americano, PDF Equilibrium)
//   Subtotais Parte A e Parte B são informativos no laudo (sem corte binário).
//
// Cálculo no banco quando paciente clica "Enviar":
//   1. Salva respostas brutas (18 itens linkados ao fator único TOTAL)
//   2. Subtotais Parte A/B e classificação recalculados no JS do laudo
//      (decisão B: armazena bruto, calcula no frontend).
// ============================================================================
        ...
        return `
            <div class="tela-consentimento">
                ...
                <ul>
                    ...
                    <li>Tempo estimado: 5 a 8 minutos.</li>
                    <li>Responda pensando em como você se <strong>sentiu e se comportou nos últimos 6 meses</strong>.</li>
                </ul>
    ...
    function renderPerguntas() {
        ...
        let html = `
            <div class="tela-perguntas-instrucoes">
                <p>Para cada afirmação abaixo, escolha a opção que melhor descreve <strong>com que frequência</strong> isso acontece com você nos últimos 6 meses.</p>
            </div>
