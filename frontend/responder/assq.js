// ============================================================================
// CORTEX_APP — ASSQ Online (HETEROAPLICAÇÃO — pais respondem)
// ============================================================================
// Página pública SEM autenticação.
// URL: /responder/assq.html?token=<uuid>
//
// Fluxo (idêntico ao RAADS-R):
//   1. Tela 1: Termo de consentimento
//   2. Tela 2: 27 itens em lista única com scroll (escala 0-2)
//   3. Tela 3: Agradecimento ("Resposta enviada. Obrigado.")
//
// Decisão clínica registrada (Ehlers, Gillberg & Wing, 1999; Restrepo, 2018):
//   ASSQ — Heteroaplicação. Pai/mãe/responsável responde sobre criança/
//   adolescente (7-16 anos). 27 itens, escala Likert 0-2 (Não/Um pouco/
//   Sim). Sem reversos. Banco grava índice 0-2 conforme escolha. JS soma
//   total e por grupo, e classifica BINÁRIO (cutoff 19/54 Restrepo 2018).
//
// Cálculo no banco quando responsável clica "Enviar":
//   1. Soma respostas brutas como índice 0-2 (publico_finalizar v2)
//   2. JS do laudo classifica binário (Dentro do Esperado vs Rastreio POS)
