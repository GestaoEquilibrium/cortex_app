...
// URL: /responder/bai.html?token=<uuid>
//
...
//
// Escala 0-3 (intensidade do sintoma). Autoaplicação. Janela: última semana, incluindo hoje.
    ...
    function renderConsentimento() {
        return `
            <div class="tela-consentimento">
                ...
                <ul>
                    <li>É uma lista de <strong>${state.itens.length} sintomas</strong>. Leia cada um com atenção.</li>
                    <li>Para cada sintoma, indique <strong>o quanto você foi incomodado por ele durante a última semana, incluindo hoje</strong>.</li>
    ...
    function renderPerguntas() {
        ...
        let html = `
            <div class="tela-perguntas-instrucoes">
                <p>Para cada sintoma, marque o quanto você foi <strong>incomodado por ele na última semana, incluindo hoje</strong>.</p>
            </div>
