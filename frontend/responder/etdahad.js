// ============================================================================
// CORTEX_APP — ETDAH-AD Online (resposta paciente)
// ============================================================================
// Página pública SEM autenticação.
// URL: /responder/etdahad.html?token=<uuid>
//
// Fluxo (idêntico ao RAADS-R):
//   1. Tela 1: Termo de consentimento
//   2. Tela 2: 69 itens em lista única com scroll
//   3. Tela 3: Agradecimento ("Resposta enviada. Obrigado.")
//
// Decisão clínica registrada (ETDAH-AD versão brasileira validada):
//   Escala 0-5 (Nunca → Sempre intensamente). 12 itens AAMA INVERTIDOS (5-raw).
//   5 fatores SEM total: Desatenção, Hiperatividade, Impulsividade,
//   Aspectos Emocionais e AAMA (Auto-Avaliação e Monitoramento do Autocontrole).
//   Classificação por percentil estratificado por escolaridade (Fund/Médio/Sup).
//
// Cálculo no banco quando paciente clica "Enviar":
//   1. Aplica inversão dos 12 itens AAMA (instrumentos_itens.reverso=true)
//   2. Soma score por FATOR (sem total)
