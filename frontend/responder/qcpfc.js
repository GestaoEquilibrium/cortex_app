// ============================================================================
// CORTEX_APP — QCP-FC Online (resposta paciente)
// ============================================================================
// Página pública SEM autenticação.
// URL: /responder/qcpfc.html?token=<uuid>
//
// Fluxo (idêntico ao RAADS-R):
//   1. Tela 1: Termo de consentimento
//   2. Tela 2: 65 itens em lista única com scroll
//   3. Tela 3: Agradecimento ("Resposta enviada. Obrigado.")
//
// Decisão clínica registrada (Beck & Beck, 1991; Butler, Beck & Cohen, 2007):
//   QCP-FC — Questionário de Crenças Pessoais (Forma Clínica/PBQ-SF).
//   65 itens, escala 0-4 (Não acredito → Acredito totalmente).
//   10 escalas de transtornos de personalidade DSM. SEM reversos.
//   5 itens compartilham mais de uma escala (cálculo correto no JS do laudo).
//
// Cálculo no banco quando paciente clica "Enviar":
//   1. Soma respostas brutas (instrumentos_itens linkados ao fator principal)
//   2. Itens compartilhados (#31, 44, 45, 49, 56) linkam ao BOR no banco;
//      JS do laudo recalcula tudo do zero (lê escores_brutos.respostas).
//   3. Z-score classificado no JS (decisão arquitetural B).
