// ============================================================================
// CORTEX_APP — SCARED-A Online (resposta paciente)
// ============================================================================
// Página pública SEM autenticação.
// URL: /responder/scareda.html?token=<uuid>
//
// Fluxo (idêntico ao RAADS-R):
//   1. Tela 1: Termo de consentimento
//   2. Tela 2: 41 itens em lista única com scroll
//   3. Tela 3: Agradecimento ("Resposta enviada. Obrigado.")
//
// Decisão clínica registrada (Birmaher et al., 1999):
//   Escala 0-2 (Nunca/Às vezes/Frequentemente). Zero reversos.
//   5 subescalas + total. Cutoff TOTAL ≥25 = rastreio positivo.
//   Respondente: a própria criança/adolescente.
//
// Cálculo automático no banco quando respondente clica "Enviar":
//   1. Soma score TOTAL e por FATOR (PANICO, GENERALIZ, SEPARACAO, SOCIAL, ESCOLAR)
//   2. Classifica em "Não Clínico" / "Risco Clínico" (binário, total ≥25)
//   3. Z-score estratificado é calculado no laudo (JS), não no banco
