...
// URL: /responder/snapiv.html?token=<uuid>
//
// Heteroaplicação: pai/mãe/responsável ou professor responde sobre a criança/adolescente.
// Fluxo:
...
//
// Escala 0-3 (Nem um pouco / Só um pouco / Bastante / Demais).
    ...
    function renderConsentimento() {
        return `
            <div class="tela-consentimento">
                ...
                <h1>Olá!</h1>
                <p class="subtitulo">Você foi convidado(a) a responder o questionário <strong>${escapeHtml(state.norma.versao_label)}</strong> sobre a criança/adolescente.</p>

                <h2>Antes de começar</h2>
                <p>Este questionário foi solicitado por um profissional como parte da avaliação da criança/adolescente. Você responde como <strong>pai, mãe, responsável ou professor(a)</strong> da criança/adolescente. As respostas serão analisadas exclusivamente pelo(a) profissional.</p>

                <h2>Como responder</h2>
                <ul>
                    <li>São <strong>${state.itens.length} afirmações</strong> sobre comportamentos que a criança/adolescente pode apresentar. Leia cada uma com atenção.</li>
                    <li>Para cada afirmação, escolha a opção que <strong>melhor descreve</strong> a criança/adolescente: <em>Nem um pouco</em>, <em>Só um pouco</em>, <em>Bastante</em> ou <em>Demais</em>.</li>
    ...
    function renderPerguntas() {
        ...
        let html = `
            <div class="tela-perguntas-instrucoes">
                <p>Para cada afirmação, marque a opção que <strong>melhor descreve</strong> a criança/adolescente — de <em>Nem um pouco</em> a <em>Demais</em>.</p>
            </div>
