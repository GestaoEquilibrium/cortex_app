// ============================================================================
// CORTEX_APP — SRS-2 Adulto Autorrelato Online
// ============================================================================
// Página pública SEM autenticação.
// URL: /responder/srs2auto.html?token=<uuid>
//
...
//   SRS-2 Adulto — Autorrelato. Adulto 19+ anos responde sobre si mesmo.
//   65 itens em 5 subescalas (Percepção/Cognição/Comunicação/Motivação
//   Social + Padrões Restritivos) + 2 compostos (CI/Total). 17 reversos.
...
(function() {
    ...
    const SIGLA_ESPERADA = 'SRS-2-AUTO';
