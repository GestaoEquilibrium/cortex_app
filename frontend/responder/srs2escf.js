// ============================================================================
// CORTEX_APP — SRS-2 Idade Escolar Feminino Online (heterorrelato)
// ============================================================================
// Página pública SEM autenticação.
// URL: /responder/srs2escf.html?token=<uuid>
//
...
//   SRS-2 Idade Escolar Feminino — Heterorrelato (cuidador/professor)
//   sobre criança/adolescente de 4 a 18 anos do sexo feminino.
//   65 itens em 5 subescalas + 2 compostos. 17 reversos. Normas
//   estratificadas por sexo (forma específica feminino).
...
(function() {
    ...
    const SIGLA_ESPERADA = 'SRS-2-ESC-F';
