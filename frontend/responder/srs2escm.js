// ============================================================================
// CORTEX_APP — SRS-2 Idade Escolar Masculino Online (heterorrelato)
// ============================================================================
// Página pública SEM autenticação.
// URL: /responder/srs2escm.html?token=<uuid>
//
...
//   SRS-2 Idade Escolar Masculino — Heterorrelato (cuidador/professor)
//   sobre criança/adolescente de 4 a 18 anos do sexo masculino.
//   65 itens em 5 subescalas + 2 compostos. 17 reversos. Normas
//   estratificadas por sexo (forma específica masculino).
//   Classificação: Típico (T≤59) / N1 / N2 / N3.
//
...
(function() {
    ...
    const SIGLA_ESPERADA = 'SRS-2-ESC-M';
