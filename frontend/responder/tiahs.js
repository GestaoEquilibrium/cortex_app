// ============================================================================
// CORTEX_APP — TIAH/S Online (Triagem de Indicadores de Altas Habilidades)
// ============================================================================
// Página pública SEM autenticação.
// URL: /responder/tiahs.html?token=<uuid>
// Respondente: professor(a) ou profissional do contexto educacional.
//
// Fluxo:
//   1. Tela 1: Termo de consentimento
//   2. Tela 2: 42 itens em lista única com scroll (4 opções)
//   3. Tela 3: Agradecimento ("Resposta enviada. Obrigado.")
//
// Escala TIAH/S — Tatiana de Cássia Nakano / Vetor Editora
//   42 itens distribuídos em 5 áreas:
//     - Capacidade Intelectual Geral (8)         · corte ≥ 22
//     - Habilidades Acadêmicas Específicas (9)   · corte ≥ 22
//     - Liderança (8)                            · corte ≥ 17
//     - Criatividade (8)                         · corte ≥ 19
//     - Talento Artístico (9)                    · corte ≥ 17
//
//   Escala armazenada 0-3 (semanticamente ordenada):
//     0 = Incapaz de julgar
//     1 = Desenvolvimento abaixo do nível esperado
//     2 = Nível igual ao apresentado por estudantes de mesma idade
//     3 = Desenvolvimento acima da média  ← único que pontua
//
//   Pontuação bruta por área = contagem(itens=3) × 3
//   Indicativo AH/S por área: bruta ≥ corte da área
//   Triagem — NÃO estabelece diagnóstico.
//
// Cálculo no banco quando avaliador clica "Enviar":
//   1. Salva respostas brutas (42 itens linkados às 5 áreas)
//   2. Indicativos por área recalculados no JS do laudo (decisão B)
        ...
        return `
            <div class="tela-consentimento">
                ...
                <ul>
                    ...
                    <li>Compare o desempenho do aluno em relação a estudantes <strong>de mesma idade e série</strong>.</li>
                </ul>
    ...
    function renderPerguntas() {
        ...
        let html = `
            <div class="tela-perguntas-instrucoes">
                <p>Para cada comportamento abaixo, escolha a opção que <strong>melhor descreve o desempenho do(a) aluno(a)</strong> em comparação a estudantes de mesma idade e série.</p>
            </div>
